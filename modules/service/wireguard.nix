        ...
        lib.mkIf config.service.wiregaurd.enable {
            ...
            in
                lib.mkIf config.sops.enable {
                    ...
                    # };
                    "VPN/PIA/wiregaurd/private" = lib.mkIf config.service.wiregaurd.PIA {
                        sopsFile = ../../secrets/${host}/vpn.yaml;
                    };
                };
            ...
            networking.wg-quick.interfaces = {
                wgpiamel0 = lib.mkIf config.service.wiregaurd.PIA {
                    type = "wireguard";
                ...
                wgpiabne0 = lib.mkIf config.service.wiregaurd.PIA {
                    type = "wireguard";
