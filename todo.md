...
- Qbitorrent web client for Orion with jackett. Will require guarantee that the connection
  goes through a VPN
...
- When creating a new terminal window/tab in a directory with direnv, it can take a
  second and commands entered in that period don't take effect, its very annoying
